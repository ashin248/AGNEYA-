...
function Contact() {
  ...
  // മൗസ് എവിടെയാണെന്ന് കണ്ടുപിടിച്ച് CSS-ലേക്ക് അയക്കുന്ന ഫംഗ്ഷൻ (Torch Effect ന് വേണ്ടി)
  ...
  return (
    <section className="contact-section" id="contact">
      ...
      >
        {/* Contact Info Group */}
        <motion.div 
          className="contact-info glow-card" 
        ...
        {/* Why Choose Group */}
        <motion.div 
          className="why-choose-box glow-card" 
          variants={gravityScrollVariant}
          onMouseMove={handleMouseMove}
        >
        ...
        {/* Mission Group */}
        <motion.div 
          className="mission-box glow-card" 
          variants={gravityScrollVariant}
          onMouseMove={handleMouseMove}
        >
